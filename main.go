...
func main() {
	...
	router.PUT("/api/received-key/update-key-pickup-pea", funcs.ApiKeyAuthenMiddleware(), receivedKeyHandler.UpdateKeyPickupPEA)
	router.PUT("/api/received-key/update-key-pickup-outsider", funcs.ApiKeyAuthenMiddleware(), receivedKeyHandler.UpdateKeyPickupOutSider)
	router.PUT("/api/received-key/update-key-pickup-driver", funcs.ApiKeyAuthenMiddleware(), receivedKeyHandler.UpdateKeyPickupDriver)
	...
	router.PUT("/api/received-vehicle/received-vehicle", funcs.ApiKeyAuthenMiddleware(), receivedVehicleHandler.ReceivedVehicle)
	...
	router.GET("/api/vehicle-in-use/travel-details/:trn_request_uid", funcs.ApiKeyAuthenMiddleware(), vehicleInUseHandler.GetVehicleTripDetails)
	router.GET("/api/vehicle-in-use/travel-detail/:trn_trip_detail_uid", funcs.ApiKeyAuthenMiddleware(), vehicleInUseHandler.GetVehicleTripDetail)
	...
	router.GET("/api/vehicle-in-use/add-fuel-details/:trn_request_uid", funcs.ApiKeyAuthenMiddleware(), vehicleInUseHandler.GetVehicleAddFuelDetails)
	router.GET("/api/vehicle-in-use/add-fuel-detail/:trn_add_fuel_uid", funcs.ApiKeyAuthenMiddleware(), vehicleInUseHandler.GetVehicleAddFuelDetail)
	...
	router.PUT("/api/vehicle-in-use/returned-vehicle", funcs.ApiKeyAuthenMiddleware(), vehicleInUseHandler.ReturnedVehicle)
