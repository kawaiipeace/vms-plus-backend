...
func main() {
	...
	driverLicenseApproverHandler := handlers.DriverLicenseApproverHandler{Role: "vehicle-user,license-approver"}
	...
	router.GET("/api/mas/driver-vendors", funcs.ApiKeyAuthenMiddleware(), masHandler.ListDriverVendor)
