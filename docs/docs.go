...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/driver/{id}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "MasDriverUID (MasDriverUID)",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
        ...
        "/api/received-vehicle/request/{id}": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/api/vehicle-in-use/add-fuel-detail/{id}": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/api/vehicle-in-use/add-fuel-details/{id}": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/api/vehicle-in-use/delete-add-fuel/{id}": {
            "delete": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/api/vehicle-in-use/delete-travel-detail/{id}": {
            "delete": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/api/vehicle-in-use/travel-detail/{id}": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/api/vehicle-in-use/travel-details": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/api/vehicle-in-use/update-add-fuel/{id}": {
            "put": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/api/vehicle-in-use/update-travel-detail/{id}": {
            "put": {
                "security": [
                    {
                        "ApiKeyAuth": []
