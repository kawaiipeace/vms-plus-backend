...
var StatusNameMapReceivedVehicle = map[string]string{
	"51":  "รับยานพาหนะ",
	"60":  "เดินทาง",
	"60e": "เกินวันเดินทาง",
}
...
func (h *ReceivedVehicleHandler) SearchRequests(c *gin.Context) {
	...
	statusNameMap := StatusNameMapReceivedVehicle
...
func (h *ReceivedVehicleHandler) GetRequest(c *gin.Context) {
	funcs.GetAuthenUser(c, h.Role)
	funcs.GetRequest(c, StatusNameMapReceivedVehicle)
}
...
// @Router /api/received-vehicle/received-vehicle [put]
func (h *ReceivedVehicleHandler) ReceivedVehicle(c *gin.Context) {
