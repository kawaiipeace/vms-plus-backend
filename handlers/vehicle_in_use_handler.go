...
// @Router /api/vehicle-in-use/request/{id} [get]
...
// @Security ApiKeyAuth
// @Security AuthorizationAuth
// @Param id path string true "TrnTripDetailUID"
// @Param data body models.VmsTrnTripDetail_Request true "VmsTrnTripDetail_Request data"
// @Router /api/vehicle-in-use/update-travel-detail/{id} [put]
...
// @Security AuthorizationAuth
// @Param id path string true "TrnTripDetailUID"
// @Router /api/vehicle-in-use/delete-travel-detail/{id} [delete]
...
// @Security AuthorizationAuth
// @Param id path string true "TrnRequestUID (trn_request_uid)"
// @Router /api/vehicle-in-use/travel-details [get]
...
// @Security AuthorizationAuth
// @Param id path string true "TrnTripDetailUID"
// @Router /api/vehicle-in-use/travel-detail/{id} [get]
...
// @Security ApiKeyAuth
// @Security AuthorizationAuth
// @Param id path string true "TrnAddFuelUID"
// @Param data body models.VmsTrnAddFuel true "VmsTrnAddFuel data"
// @Router /api/vehicle-in-use/update-add-fuel/{id} [put]
...
// @Security AuthorizationAuth
// @Param id path string true "TrnAddFuelUID"
// @Router /api/vehicle-in-use/delete-add-fuel/{id} [delete]
...
// @Security ApiKeyAuth
// @Security AuthorizationAuth
// @Param id path string true "TrnRequestUID"
// @Router /api/vehicle-in-use/add-fuel-details/{id} [get]
...
// @Security AuthorizationAuth
// @Param id path string true "TrnAddFuelUID"
// @Router /api/vehicle-in-use/add-fuel-detail/{id} [get]
