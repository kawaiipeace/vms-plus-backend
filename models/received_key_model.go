...
type VmsTrnVehicleKeyHandover struct {
	...
	AppointmentPlace string       `gorm:"column:appointment_place" json:"appointment_place" example:"Main Office"`
...
type VmsTrnRequestUpdateRecieivedKey struct {
	...
	ReceivedKeyEndDatetime   TimeWithZone `gorm:"column:appointment_end" json:"received_key_end_datetime" swaggertype:"string" example:"2025-02-16T17:00:00Z"`
	UpdatedAt                time.Time    `gorm:"column:updated_at" json:"-"`
	UpdatedBy                string       `gorm:"column:updated_by" json:"-"`
}
