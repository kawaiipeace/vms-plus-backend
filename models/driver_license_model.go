...
type VmsDriverLicenseCardLicense struct {
	...
	DriverLicenseStartDate   TimeWithZone            `gorm:"column:driver_license_start_date" json:"driver_license_start_date"`
...
type VmsDriverLicenseAnnualList struct {
	...
	CreatedRequestDatetime           TimeWithZone `gorm:"column:created_request_datetime" json:"created_request_datetime"`
...
type VmsDriverLicenseAnnualResponse struct {
	...
	ConfirmedRequestDatetime     TimeWithZone `gorm:"column:confirmed_request_datetime" json:"confirmed_request_datetime"`
	...
	ApprovedRequestDatetime     TimeWithZone `gorm:"column:approved_request_datetime" json:"approved_request_datetime"`
	...
	RejectedRequestDatetime     TimeWithZone `gorm:"column:rejected_request_datetime" json:"rejected_request_datetime"`
...
type VmsDriverLicenseAnnualConfirmed struct {
	...
	ConfirmedRequestDeptSAPShort     string       `gorm:"column:confirmed_request_dept_sap_short" json:"-"`
	ConfirmedRequestDeptSAPFull      string       `gorm:"column:confirmed_request_dept_sap_full" json:"-"`
	ConfirmedRequestDatetime         TimeWithZone `gorm:"column:confirmed_request_datetime" json:"-"`
	RefRequestAnnualDriverStatusCode string       `gorm:"column:ref_request_annual_driver_status_code" json:"-"`
	UpdatedAt                        time.Time    `gorm:"column:updated_at" json:"-"`
	UpdatedBy                        string       `gorm:"column:updated_by" json:"-"`
}
